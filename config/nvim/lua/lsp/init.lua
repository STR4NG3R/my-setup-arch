...
vim.cmd("nnoremap <silent> ac :Lspsaga code_action<CR>")
vim.cmd("nnoremap <silent> K :Lspsaga hover_doc<CR>")
vim.cmd("nnoremap <silent> gy :LspTypeDefinittion<CR>")
vim.cmd("nnoremap <silent><A-f> :LspFormatting<CR>")
vim.cmd("nnoremap <silent> rn :LspRename<CR>")
...
vim.cmd "nmap <silent> gp <cmd>lua require'lsp'.PeekDefinition()<CR>"
--vim.cmd "nmap <silent> K :lua vim.lsp.buf.hover()<CR>"
vim.cmd("nnoremap <silent> [g :Lspsaga diagnostic_jump_prev<CR>")
vim.cmd("nnoremap <silent> ]g :Lspsaga diagnostic_jump_next<CR>")
vim.cmd "nmap <silent> K <cmd>lua vim.lsp.buf.signature_help()<CR>"
